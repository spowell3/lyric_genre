...
lyrics_sub = lyrics_sub.replace('Hip-Hop', 'Hip-Hop/R&B')
lyrics_sub = lyrics_sub.replace('R&B', 'Hip-Hop/R&B')
lyrics_sub = lyrics_sub.replace('Folk', 'Folk/Indie')
lyrics_sub = lyrics_sub.replace('Indie', 'Folk/Indie')

with open('fit_trans.pkl', 'rb') as f:
    word_vec = pickle.load(f)
print("done")

X_train, X_test, y_train, y_test = train_test_split(word_vec, lyrics_sub['genre'], test_size=0.20, stratify = lyrics_sub['genre'])
